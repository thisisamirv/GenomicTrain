...
knitr::include_graphics("Figures/11-6.jpeg")
```

2- Call peaks from alignment results:

```{r, echo=FALSE, fig.align='center', fig.pos='H', fig.show='hold', out.width = '60%'}
knitr::include_graphics("Figures/11-7.jpeg")
```

3- Check peak calling results:

```{r, echo=FALSE, fig.align='center', fig.pos='H', fig.show='hold', out.width = '100%'}
knitr::include_graphics("Figures/11-8.jpeg")
```
...
```{r, echo=FALSE, fig.align='center', fig.pos='H', fig.show='hold', fig.cap="In this example, the TF is both activating and repressing.", out.width = '50%'}
knitr::include_graphics("Figures/11-9.jpeg")
```

* Target genes:

```{r, echo=FALSE, fig.align='center', fig.pos='H', fig.show='hold', out.width = '75%'}
knitr::include_graphics("Figures/11-10.jpeg")
```

* Associated peaks:

```{r, echo=FALSE, fig.align='center', fig.pos='H', fig.show='hold', fig.cap="This data tells us what specific peaks contributed to the finding of target genes.", out.width = '75%'}
knitr::include_graphics("Figures/11-11.jpeg")
```

* motifs enriched in ChIP-seq peaks:

```{r, echo=FALSE, fig.align='center', fig.pos='H', fig.show='hold', out.width = '75%'}
knitr::include_graphics("Figures/11-12.jpeg")
```
