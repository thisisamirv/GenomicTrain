...
knitr::include_graphics("Figures/9-4.jpeg")
```
...
knitr::include_graphics("Figures/9-5.jpeg")
```
...
knitr::include_graphics("Figures/9-9.jpeg")
```

* Target genes:

```{r, echo=FALSE, fig.align='center', fig.pos='H', fig.show='hold', fig.cap="9-10", out.width = '75%'}
knitr::include_graphics("Figures/9-10.jpeg")
```
