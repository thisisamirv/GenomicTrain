...
* Epigenomic data:
  * Methylomic data: bounded by the number of CpG sequences in the genome
  * Others
...
# Data management
## Python
### Read, count, and reverse complement
Read genomic data:
```{python}
...
human_seqs, human_quals = readReads('Data/SRR835775_1.first1000.fastq')
print(human_seqs[1])
print(human_quals[1])
```
...
```{r, echo=FALSE, fig.align='center', fig.pos='H', fig.show='hold', out.width = '100%', fig.cap='Intra-range methods 1'}
knitr::include_graphics("Figures/1-1.jpeg")
```

```{r, echo=FALSE, fig.align='center', fig.pos='H', fig.show='hold', out.width = '100%', fig.cap='Intra-range methods 2'}
knitr::include_graphics("Figures/1-2.jpeg")
```
...
```{r, echo=FALSE, fig.align='center', fig.pos='H', fig.show='hold', out.width = '100%', fig.cap='Inter-range methods'}
knitr::include_graphics("Figures/1-3.jpeg")
```
...
knitr::include_graphics("Figures/1-4.jpeg")
```

```{r, echo=FALSE, fig.align='center', fig.pos='H', fig.show='hold', out.width = '100%'}
knitr::include_graphics("Figures/1-5.jpeg")
```
...
```{r}
library(snpStats)
snps <- read.plink(bed = "Data/obesity.bed",
...
```{r, echo=FALSE, fig.align='center', fig.pos='H', fig.show='hold', out.width = '100%', fig.cap='ExpressionSet data'}
knitr::include_graphics("Figures/1-6.jpeg")
```
...
```{r, echo=FALSE, fig.align='center', fig.pos='H', fig.show='hold', out.width = '100%', fig.cap='SummarizedExperiment data'}
knitr::include_graphics("Figures/1-7.jpeg")
```
